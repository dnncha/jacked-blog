(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,827,i=>{"use strict";var e=i.i(43476),a=i.i(71645),t=i.i(22016),o=i.i(62368);function r({href:i,placement:a,children:t="Start free on iPhone",experimentName:n="",experimentVariant:s="",heroPresentation:c="",copyVersion:l="",className:d="",ariaLabel:p=""}){return(0,e.jsxs)("a",{className:`acquisition-store-link${d?` ${d}`:""}`,href:i,target:"_blank",rel:"noopener noreferrer","aria-label":p||void 0,"data-global-cta":a,"data-app-store-placement":a,"data-app-store-campaign":function(i){try{return new URL(i).searchParams.get("ct")||""}catch{return""}}(i),"data-experiment":n||void 0,"data-experiment-variant":s||void 0,"data-hero-presentation":c||void 0,"data-copy-version":l||void 0,children:[(0,e.jsx)(o.Download,{"aria-hidden":"true",size:23,strokeWidth:2.2}),(0,e.jsxs)("span",{children:[(0,e.jsx)("small",{children:"Free on the App Store"}),t]})]})}i.s(["default",0,function({eyebrow:i,title:o,intro:n,campaignUrl:s,campaignKey:c,heroImage:l,heroImageAlt:d,benefits:p,steps:m,comparison:h,faqs:u,related:g,finalTitle:x,finalCopy:q,canonicalPath:b="/",heroPresentation:f="photo",benefitsTitle:v="Less admin between sets. More useful training context.",benefitsIntro:w="Surpass keeps the details that change your next decision inside the active workout.",flowTitle:y="From your last result to the next working set.",flowIntro:j="The app stays focused on the workout you are running, not a feed or a generic dashboard.",comparisonTitle:k="A training log should help with the next decision.",comparisonIntro:N="History is most useful when it is visible before the set it affects.",comparisonLabel:S="Basic workout log and Surpass comparison",faqTitle:z="Questions lifters ask before switching."}){let _="acquisition_promise_v2",A=(0,a.useRef)(null),[$,L]=(0,a.useState)(!1);(0,a.useEffect)(()=>{let i=A.current;if(!i)return;if(!("IntersectionObserver"in window))return void L(!0);let e=new IntersectionObserver(([i])=>{L(!i.isIntersecting)},{threshold:.15});return e.observe(i),()=>e.disconnect()},[]);let P={"@context":"https://schema.org","@type":"FAQPage",mainEntity:u.map(({question:i,answer:e})=>({"@type":"Question",name:i,acceptedAnswer:{"@type":"Answer",text:e}}))},C={"@context":"https://schema.org","@type":"WebPage",name:o,description:n,url:`https://jacked.coach${b}`,isPartOf:{"@type":"WebSite",name:"Surpass",url:"https://jacked.coach"},about:{"@type":"SoftwareApplication",name:"Surpass",operatingSystem:"iOS",applicationCategory:"HealthApplication"}},O={"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Surpass",item:"https://jacked.coach/"},{"@type":"ListItem",position:2,name:o,item:`https://jacked.coach${b}`}]};return(0,e.jsxs)("div",{className:"acquisition-page",children:[(0,e.jsx)("style",{children:`
        :root {
          --acq-gold: #f5b935;

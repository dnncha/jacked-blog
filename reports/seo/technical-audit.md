...
- Sitemap fetch: 200
- URLs listed in sitemap: 317
- URLs discovered from sitemap, known routes, and internal links: 329
- HTML/XML URLs audited: 326
- Non-HTML assets fetched: 3
- URLs not audited because of the bound: 0
- Fetch-blocked URLs: 0
- Audit bound: 500 pages, 6 concurrent requests, 12000ms timeout

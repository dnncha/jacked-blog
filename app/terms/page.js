...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro="By downloading, installing, or using Surpass, you agree to these terms. If you do not agree, do not use the app."
    >
      <h2>Description of service</h2>
      <p>
        Surpass is a strength and hypertrophy training app that helps you plan workouts, log sets, track progression, review progress, and manage training volume.
      </p>

      <h2>Use of the app</h2>
      <p>
        You agree to use Surpass for personal fitness tracking and training support. You must be at least 13 years old to use the app.
      </p>

      <h2>Health disclaimer</h2>
      <p>
        Surpass is a fitness tracking tool, not a medical device. Training suggestions are algorithmically generated from logged data and should not be treated as medical advice.
      </p>
      <ul>
      ...
      <p>
        Surpass may offer optional paid features through Apple's In-App Purchase system. Purchases and subscriptions are processed by Apple and subject to Apple's terms.
      </p>
      ...
      <p>
        To the maximum extent permitted by law, Surpass and its developers are not liable for indirect, incidental, special, consequential, or punitive damages arising from use of the app.
      </p>

...
export const metadata = {
  ...
  twitter: {
    ...
    title: 'Bring FitNotes Workout History to Surpass',
    description: 'Review a FitNotes workout CSV before importing it into Surpass.',
    images: ['/og-image.png'],
  },
}
...
const benefits = [
  ...
  { title: 'Inspect the history first', copy: 'Surpass checks the file for workout dates and exercise rows, then shows a preview before saving.' },
...
const steps = [
  ...
  { title: 'Choose FitNotes in Surpass', copy: 'Open Import Workout History, select FitNotes, and choose the workout CSV—not a backup database.' },
  { title: 'Review and confirm', copy: 'Check the imported date range, workout count, and exercise matches before Surpass adds the history.' },
]
...
const faqs = [
  { question: 'Which FitNotes file should I export?', answer: 'Choose the completed-workout or workout-data CSV export. Do not select a FitNotes backup database or full-app backup for the Surpass CSV importer.' },
  ...
  { question: 'What FitNotes data can Surpass import?', answer: 'Surpass supports workout dates, exercise names, weights in kilograms or pounds, reps, distance, duration, and notes when those columns are present.' },
  { question: 'Does Surpass change or delete my FitNotes data?', answer: 'No. Surpass reads the CSV copy you select. It does not connect to FitNotes or modify the original app data.' },
  { question: 'Can I remove a FitNotes import later?', answer: 'Yes. Imported sessions and their derived history can be removed separately while workouts logged manually in Surpass remain untouched.' },
]
...
export default function FitNotesAlternativePage() {
  return <AcquisitionLanding
    ...
    intro="Export your FitNotes workout CSV, review it in Surpass, then use supported historical lifts for progress views, weekly muscle context, and the next set."
    ...
    benefitsIntro="Surpass uses the workout CSV you select on your iPhone. The original FitNotes data stays where it is."
    steps={steps}
    flowTitle="FitNotes CSV to Surpass in three steps."
    ...
    finalCopy="Start free on iPhone, inspect your FitNotes workout CSV, and decide what to bring into your next training block."
  />
}
